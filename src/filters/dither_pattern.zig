pub const ZIMG_BLUE_NOISE_LEN: comptime_int = 64;
pub const ZIMG_BLUE_NOISE_SCALE: comptime_int = 255;
pub const ZIMG_BLUE_NOISE_TABLE: [ZIMG_BLUE_NOISE_LEN][ZIMG_BLUE_NOISE_LEN]u8 = .{
...
pub const VOID_CLUSTER_LEN: comptime_int = 32;
pub const VOID_CLUSTER_PACKED: [VOID_CLUSTER_LEN * VOID_CLUSTER_LEN / 8]u64 = .{
    0xD07BB295D604426F, 0x3086D23FC529146D, 0x308DA970F118CBE9, 0x557F12E273D3658E,
    0x3E58E01B4F81CCF1, 0xB30A679E76E992D3, 0x49C423D943B78B27, 0xABFDBF5AAF351AFB,
    0x0BA62D6BF99B2C19, 0x5A90FA1FB03A60A6, 0x06EC63880B5C74D8, 0x026B3B8F09E7C180,
    0xEDCD8CB713C474A5, 0xDC36CA4EE30DC1F9, 0x579D35B1CFF63895, 0x4DC920D5799F4661,
    0x217348E73857E543, 0xC07C006497822642, 0x851BE5784CA214B3, 0xE47EA4EB5226B491,
    0x3CBD0765A8910667, 0x239DE6BA3FD768B4, 0xDD61C5012B71EC27, 0x60400E336CF801DE,
    0xA2F785D421FFC985, 0xF2512F7515A2EF08, 0x9239A7FE92CC5589, 0xBBFE8EAEC287CF5E,
    0x19542EB57A4D32A2, 0x0FB58BFEC328517A, 0xCD18528142AD1CD6, 0x026ECE5817452E76,
    0xDB9AEC4311BC6DD0, 0x5DE11C455F90D230, 0xAFEE6AC110E96739, 0x9D4B21F19AE8A9BF,
    0x890A63A7E28DEF26, 0x419970CAA60EF570, 0x489B27DD35997DF4, 0xB7DC75377F660D49,
    0x6D2BCF7C1F5606B0, 0x83D407ED3481B81C, 0xDB0477B15CD1084F, 0x298A0BB3D827C7FF,
    0xB1EE4EBD3AD79C65, 0xF632B9506BE33C5C, 0x89A94DF28E22C3AC, 0x63EDC5469F5C913A,
    0x19A00096FA70C949, 0x17799424AE0A9ACE, 0xFD34C115416CFB82, 0x1697581FF608E477,
    0x52E06933860F28B6, 0xDD59D0FC86C24C77, 0x1166E47ED39E2C47, 0xDB37D26F85AC2ECE,
    0x8B24B0EA55AAE78D, 0x38A4033E5F1DEF2D, 0xBB942059B405E2B9, 0x69A302BCDE4B64B8,
    0x3B7BD413C23E7B62, 0x1EF172C8A1D96EA8, 0xDF44A4F531795B8F, 0x21F97C3C249913FF,
    0x079F476398F906D6, 0x94B84F8315398C03, 0x5B820CCB4A97EB0E, 0xCD51B262F0C772D8,
    0x5BF4C71D832B57C4, 0x4611E32CF7B448C8, 0xFF36DA72BE23AB42, 0x872DE193188444AA,
    0x902D75E8BBA8DF76, 0x32AD6ACF965DE622, 0x67AE8E5612FC5FDA, 0x6CA00B4BD332BE1B,
    0xE5B5531640690C9C, 0xF38A531D780CA07E, 0xBD162AE59E8337B2, 0x1AC6F574A460DB6E,
    0x4703A1D990F64D25, 0xD500BCEF44C634D7, 0x50EEA64566D201F0, 0x91573ABA26FA1088,
    0xC8F37B6231C87FB8, 0x5B7336A58CE06E08, 0x95387CC61EB95378, 0x31D882058F4CB12E,
    0x5E3CBA20AD13EA3E, 0x96FBCB155A25A9FC, 0x60CE10F78F3DE9A5, 0x16B55FE6CA6AEB9E,
    0xDF1987FC599C6D09, 0xB0224A80EDBB3D86, 0x1BAB7258AE0C68CC, 0x49F32A9F401D7D0A,
    0x946CC94ADA34CBE3, 0x8764DDA16A0554C5, 0xDC48EC2C81E19825, 0x7F956F12ACD454BE,
    0x2441A704937D1C55, 0x39C30F31D592F378, 0x309A00C0D53756FE, 0x04C0DE4EFD8833F2,
    0x74D1EE2A66C0F4AA, 0x93F776B24320A50F, 0x64B68B501A7ABAA3, 0x405E2F79C20761A1,
    0x0D527EB3DE144771, 0x032953E788BF4CCD, 0xE83FFD69A7EA176B, 0xE6D1AA1E9B46E1B7,
    0xF81F993B5DA02FE8, 0xB6D69D1862FB7328, 0x8414C729D144932B, 0x80098DEB68D02A8C,
    0x5DC3D909FA7ACC8A, 0x613D80CA350298DC, 0xAC5E9777055AF8C4, 0x4EB6365617AF753D,
    0xA3714A89BE235111, 0xE01EA871DFAF4154, 0x1AD73BBDE284AD0E, 0xDA6FF2C684F501E4,
    0x2812F03365ABEA96, 0xBF4FF410598AF0BC, 0x7DF80D509C2F683F, 0x9822A345259B4BB9,
};

pub const ZIMG_BAYER_TABLE_LEN: comptime_int = 16;
pub const ZIMG_BAYER_TABLE_SCALE: comptime_int = 255;
pub const ZIMG_BAYER_TABLE: [ZIMG_BAYER_TABLE_LEN][ZIMG_BAYER_TABLE_LEN]u8 = .{
...
pub const OstromTableEntry = struct {
    c0: i32,
    c1: i32,
    c2: i32,
    sum: i32,
...
pub const ostrom_table: [256]OstromTableEntry = blk: {
    break :blk [256]OstromTableEntry{
        .{ .c0 = 13, .c1 = 0, .c2 = 5, .sum = 18, .inv_sum = 1.0 / 18.0 },
        .{ .c0 = 13, .c1 = 0, .c2 = 5, .sum = 18, .inv_sum = 1.0 / 18.0 },
        .{ .c0 = 21, .c1 = 0, .c2 = 10, .sum = 31, .inv_sum = 1.0 / 31.0 },
        .{ .c0 = 7, .c1 = 0, .c2 = 4, .sum = 11, .inv_sum = 1.0 / 11.0 },
        .{ .c0 = 8, .c1 = 0, .c2 = 5, .sum = 13, .inv_sum = 1.0 / 13.0 },
        .{ .c0 = 47, .c1 = 3, .c2 = 28, .sum = 78, .inv_sum = 1.0 / 78.0 },
        .{ .c0 = 23, .c1 = 3, .c2 = 13, .sum = 39, .inv_sum = 1.0 / 39.0 },
        .{ .c0 = 15, .c1 = 3, .c2 = 8, .sum = 26, .inv_sum = 1.0 / 26.0 },
        .{ .c0 = 22, .c1 = 6, .c2 = 11, .sum = 39, .inv_sum = 1.0 / 39.0 },
        .{ .c0 = 43, .c1 = 15, .c2 = 20, .sum = 78, .inv_sum = 1.0 / 78.0 },
        .{ .c0 = 7, .c1 = 3, .c2 = 3, .sum = 13, .inv_sum = 1.0 / 13.0 },
        .{ .c0 = 501, .c1 = 224, .c2 = 211, .sum = 936, .inv_sum = 1.0 / 936.0 },
        .{ .c0 = 249, .c1 = 116, .c2 = 103, .sum = 468, .inv_sum = 1.0 / 468.0 },
        .{ .c0 = 165, .c1 = 80, .c2 = 67, .sum = 312, .inv_sum = 1.0 / 312.0 },
        .{ .c0 = 123, .c1 = 62, .c2 = 49, .sum = 234, .inv_sum = 1.0 / 234.0 },
        .{ .c0 = 489, .c1 = 256, .c2 = 191, .sum = 936, .inv_sum = 1.0 / 936.0 },
        .{ .c0 = 81, .c1 = 44, .c2 = 31, .sum = 156, .inv_sum = 1.0 / 156.0 },
        .{ .c0 = 483, .c1 = 272, .c2 = 181, .sum = 936, .inv_sum = 1.0 / 936.0 },
        .{ .c0 = 60, .c1 = 35, .c2 = 22, .sum = 117, .inv_sum = 1.0 / 117.0 },
        .{ .c0 = 53, .c1 = 32, .c2 = 19, .sum = 104, .inv_sum = 1.0 / 104.0 },
        .{ .c0 = 237, .c1 = 148, .c2 = 83, .sum = 468, .inv_sum = 1.0 / 468.0 },
        .{ .c0 = 471, .c1 = 304, .c2 = 161, .sum = 936, .inv_sum = 1.0 / 936.0 },
        .{ .c0 = 3, .c1 = 2, .c2 = 1, .sum = 6, .inv_sum = 1.0 / 6.0 },
        .{ .c0 = 481, .c1 = 314, .c2 = 185, .sum = 980, .inv_sum = 1.0 / 980.0 },
        .{ .c0 = 354, .c1 = 226, .c2 = 155, .sum = 735, .inv_sum = 1.0 / 735.0 },
        .{ .c0 = 1389, .c1 = 866, .c2 = 685, .sum = 2940, .inv_sum = 1.0 / 2940.0 },
        .{ .c0 = 227, .c1 = 138, .c2 = 125, .sum = 490, .inv_sum = 1.0 / 490.0 },
        .{ .c0 = 267, .c1 = 158, .c2 = 163, .sum = 588, .inv_sum = 1.0 / 588.0 },
        .{ .c0 = 327, .c1 = 188, .c2 = 220, .sum = 735, .inv_sum = 1.0 / 735.0 },
        .{ .c0 = 61, .c1 = 34, .c2 = 45, .sum = 140, .inv_sum = 1.0 / 140.0 },
        .{ .c0 = 627, .c1 = 338, .c2 = 505, .sum = 1470, .inv_sum = 1.0 / 1470.0 },
        .{ .c0 = 1227, .c1 = 638, .c2 = 1075, .sum = 2940, .inv_sum = 1.0 / 2940.0 },
        .{ .c0 = 20, .c1 = 10, .c2 = 19, .sum = 49, .inv_sum = 1.0 / 49.0 },
        .{ .c0 = 1937, .c1 = 1000, .c2 = 1767, .sum = 4704, .inv_sum = 1.0 / 4704.0 },
        .{ .c0 = 977, .c1 = 520, .c2 = 855, .sum = 2352, .inv_sum = 1.0 / 2352.0 },
        .{ .c0 = 657, .c1 = 360, .c2 = 551, .sum = 1568, .inv_sum = 1.0 / 1568.0 },
        .{ .c0 = 71, .c1 = 40, .c2 = 57, .sum = 168, .inv_sum = 1.0 / 168.0 },
        .{ .c0 = 2005, .c1 = 1160, .c2 = 1539, .sum = 4704, .inv_sum = 1.0 / 4704.0 },
        .{ .c0 = 337, .c1 = 200, .c2 = 247, .sum = 784, .inv_sum = 1.0 / 784.0 },
        .{ .c0 = 2039, .c1 = 1240, .c2 = 1425, .sum = 4704, .inv_sum = 1.0 / 4704.0 },
        .{ .c0 = 257, .c1 = 160, .c2 = 171, .sum = 588, .inv_sum = 1.0 / 588.0 },
        .{ .c0 = 691, .c1 = 440, .c2 = 437, .sum = 1568, .inv_sum = 1.0 / 1568.0 },
        .{ .c0 = 1045, .c1 = 680, .c2 = 627, .sum = 2352, .inv_sum = 1.0 / 2352.0 },
        .{ .c0 = 301, .c1 = 200, .c2 = 171, .sum = 672, .inv_sum = 1.0 / 672.0 },
        .{ .c0 = 177, .c1 = 120, .c2 = 95, .sum = 392, .inv_sum = 1.0 / 392.0 },
        .{ .c0 = 2141, .c1 = 1480, .c2 = 1083, .sum = 4704, .inv_sum = 1.0 / 4704.0 },
        .{ .c0 = 1079, .c1 = 760, .c2 = 513, .sum = 2352, .inv_sum = 1.0 / 2352.0 },
        .{ .c0 = 725, .c1 = 520, .c2 = 323, .sum = 1568, .inv_sum = 1.0 / 1568.0 },
        .{ .c0 = 137, .c1 = 100, .c2 = 57, .sum = 294, .inv_sum = 1.0 / 294.0 },
        .{ .c0 = 2209, .c1 = 1640, .c2 = 855, .sum = 4704, .inv_sum = 1.0 / 4704.0 },
        .{ .c0 = 53, .c1 = 40, .c2 = 19, .sum = 112, .inv_sum = 1.0 / 112.0 },
        .{ .c0 = 2243, .c1 = 1720, .c2 = 741, .sum = 4704, .inv_sum = 1.0 / 4704.0 },
        .{ .c0 = 565, .c1 = 440, .c2 = 171, .sum = 1176, .inv_sum = 1.0 / 1176.0 },
        .{ .c0 = 759, .c1 = 600, .c2 = 209, .sum = 1568, .inv_sum = 1.0 / 1568.0 },
        .{ .c0 = 1147, .c1 = 920, .c2 = 285, .sum = 2352, .inv_sum = 1.0 / 2352.0 },
        .{ .c0 = 2311, .c1 = 1880, .c2 = 513, .sum = 4704, .inv_sum = 1.0 / 4704.0 },
        .{ .c0 = 97, .c1 = 80, .c2 = 19, .sum = 196, .inv_sum = 1.0 / 196.0 },
        .{ .c0 = 335, .c1 = 280, .c2 = 57, .sum = 672, .inv_sum = 1.0 / 672.0 },
        .{ .c0 = 1181, .c1 = 1000, .c2 = 171, .sum = 2352, .inv_sum = 1.0 / 2352.0 },
        .{ .c0 = 793, .c1 = 680, .c2 = 95, .sum = 1568, .inv_sum = 1.0 / 1568.0 },
        .{ .c0 = 599, .c1 = 520, .c2 = 57, .sum = 1176, .inv_sum = 1.0 / 1176.0 },
        .{ .c0 = 2413, .c1 = 2120, .c2 = 171, .sum = 4704, .inv_sum = 1.0 / 4704.0 },
        .{ .c0 = 405, .c1 = 360, .c2 = 19, .sum = 784, .inv_sum = 1.0 / 784.0 },
        .{ .c0 = 2447, .c1 = 2200, .c2 = 57, .sum = 4704, .inv_sum = 1.0 / 4704.0 },
        .{ .c0 = 11, .c1 = 10, .c2 = 0, .sum = 21, .inv_sum = 1.0 / 21.0 },
        .{ .c0 = 158, .c1 = 151, .c2 = 3, .sum = 312, .inv_sum = 1.0 / 312.0 },
        .{ .c0 = 178, .c1 = 179, .c2 = 7, .sum = 364, .inv_sum = 1.0 / 364.0 },
        .{ .c0 = 1030, .c1 = 1091, .c2 = 63, .sum = 2184, .inv_sum = 1.0 / 2184.0 },
        .{ .c0 = 248, .c1 = 277, .c2 = 21, .sum = 546, .inv_sum = 1.0 / 546.0 },
        .{ .c0 = 318, .c1 = 375, .c2 = 35, .sum = 728, .inv_sum = 1.0 / 728.0 },
        .{ .c0 = 458, .c1 = 571, .c2 = 63, .sum = 1092, .inv_sum = 1.0 / 1092.0 },
        .{ .c0 = 878, .c1 = 1159, .c2 = 147, .sum = 2184, .inv_sum = 1.0 / 2184.0 },
        .{ .c0 = 5, .c1 = 7, .c2 = 1, .sum = 13, .inv_sum = 1.0 / 13.0 },
        .{ .c0 = 172, .c1 = 181, .c2 = 37, .sum = 390, .inv_sum = 1.0 / 390.0 },
        .{ .c0 = 97, .c1 = 76, .c2 = 22, .sum = 195, .inv_sum = 1.0 / 195.0 },
        .{ .c0 = 72, .c1 = 41, .c2 = 17, .sum = 130, .inv_sum = 1.0 / 130.0 },
        .{ .c0 = 119, .c1 = 47, .c2 = 29, .sum = 195, .inv_sum = 1.0 / 195.0 },
        .{ .c0 = 4, .c1 = 1, .c2 = 1, .sum = 6, .inv_sum = 1.0 / 6.0 },
        .{ .c0 = 4, .c1 = 1, .c2 = 1, .sum = 6, .inv_sum = 1.0 / 6.0 },
        .{ .c0 = 4, .c1 = 1, .c2 = 1, .sum = 6, .inv_sum = 1.0 / 6.0 },
        .{ .c0 = 4, .c1 = 1, .c2 = 1, .sum = 6, .inv_sum = 1.0 / 6.0 },
        .{ .c0 = 4, .c1 = 1, .c2 = 1, .sum = 6, .inv_sum = 1.0 / 6.0 },
        ...
        .{ .c0 = 4, .c1 = 1, .c2 = 1, .sum = 6, .inv_sum = 1.0 / 6.0 },
        .{ .c0 = 4, .c1 = 1, .c2 = 1, .sum = 6, .inv_sum = 1.0 / 6.0 },
        .{ .c0 = 65, .c1 = 18, .c2 = 17, .sum = 100, .inv_sum = 1.0 / 100.0 },
        .{ .c0 = 95, .c1 = 29, .c2 = 26, .sum = 150, .inv_sum = 1.0 / 150.0 },
        .{ .c0 = 185, .c1 = 62, .c2 = 53, .sum = 300, .inv_sum = 1.0 / 300.0 },
        .{ .c0 = 30, .c1 = 11, .c2 = 9, .sum = 50, .inv_sum = 1.0 / 50.0 },
        .{ .c0 = 35, .c1 = 14, .c2 = 11, .sum = 60, .inv_sum = 1.0 / 60.0 },
        .{ .c0 = 85, .c1 = 37, .c2 = 28, .sum = 150, .inv_sum = 1.0 / 150.0 },
        .{ .c0 = 55, .c1 = 26, .c2 = 19, .sum = 100, .inv_sum = 1.0 / 100.0 },
        .{ .c0 = 80, .c1 = 41, .c2 = 29, .sum = 150, .inv_sum = 1.0 / 150.0 },
        .{ .c0 = 155, .c1 = 86, .c2 = 59, .sum = 300, .inv_sum = 1.0 / 300.0 },
        .{ .c0 = 5, .c1 = 3, .c2 = 2, .sum = 10, .inv_sum = 1.0 / 10.0 },
        .{ .c0 = 5, .c1 = 3, .c2 = 2, .sum = 10, .inv_sum = 1.0 / 10.0 },
        .{ .c0 = 5, .c1 = 3, .c2 = 2, .sum = 10, .inv_sum = 1.0 / 10.0 },
        .{ .c0 = 5, .c1 = 3, .c2 = 2, .sum = 10, .inv_sum = 1.0 / 10.0 },
        .{ .c0 = 5, .c1 = 3, .c2 = 2, .sum = 10, .inv_sum = 1.0 / 10.0 },
        ...
        .{ .c0 = 5, .c1 = 3, .c2 = 2, .sum = 10, .inv_sum = 1.0 / 10.0 },
        .{ .c0 = 5, .c1 = 3, .c2 = 2, .sum = 10, .inv_sum = 1.0 / 10.0 },
        .{ .c0 = 305, .c1 = 176, .c2 = 119, .sum = 600, .inv_sum = 1.0 / 600.0 },
        .{ .c0 = 155, .c1 = 86, .c2 = 59, .sum = 300, .inv_sum = 1.0 / 300.0 },
        .{ .c0 = 105, .c1 = 56, .c2 = 39, .sum = 200, .inv_sum = 1.0 / 200.0 },
        .{ .c0 = 80, .c1 = 41, .c2 = 29, .sum = 150, .inv_sum = 1.0 / 150.0 },
        .{ .c0 = 65, .c1 = 32, .c2 = 23, .sum = 120, .inv_sum = 1.0 / 120.0 },
        .{ .c0 = 55, .c1 = 26, .c2 = 19, .sum = 100, .inv_sum = 1.0 / 100.0 },
        .{ .c0 = 335, .c1 = 152, .c2 = 113, .sum = 600, .inv_sum = 1.0 / 600.0 },
        .{ .c0 = 85, .c1 = 37, .c2 = 28, .sum = 150, .inv_sum = 1.0 / 150.0 },
        .{ .c0 = 115, .c1 = 48, .c2 = 37, .sum = 200, .inv_sum = 1.0 / 200.0 },
        .{ .c0 = 35, .c1 = 14, .c2 = 11, .sum = 60, .inv_sum = 1.0 / 60.0 },
        .{ .c0 = 355, .c1 = 136, .c2 = 109, .sum = 600, .inv_sum = 1.0 / 600.0 },
        .{ .c0 = 30, .c1 = 11, .c2 = 9, .sum = 50, .inv_sum = 1.0 / 50.0 },
        .{ .c0 = 365, .c1 = 128, .c2 = 107, .sum = 600, .inv_sum = 1.0 / 600.0 },
        .{ .c0 = 185, .c1 = 62, .c2 = 53, .sum = 300, .inv_sum = 1.0 / 300.0 },
        .{ .c0 = 25, .c1 = 8, .c2 = 7, .sum = 40, .inv_sum = 1.0 / 40.0 },
        .{ .c0 = 95, .c1 = 29, .c2 = 26, .sum = 150, .inv_sum = 1.0 / 150.0 },
        .{ .c0 = 385, .c1 = 112, .c2 = 103, .sum = 600, .inv_sum = 1.0 / 600.0 },
        .{ .c0 = 65, .c1 = 18, .c2 = 17, .sum = 100, .inv_sum = 1.0 / 100.0 },
        .{ .c0 = 395, .c1 = 104, .c2 = 101, .sum = 600, .inv_sum = 1.0 / 600.0 },
        .{ .c0 = 4, .c1 = 1, .c2 = 1, .sum = 6, .inv_sum = 1.0 / 6.0 },
        .{ .c0 = 4, .c1 = 1, .c2 = 1, .sum = 6, .inv_sum = 1.0 / 6.0 },
        .{ .c0 = 395, .c1 = 104, .c2 = 101, .sum = 600, .inv_sum = 1.0 / 600.0 },
        .{ .c0 = 65, .c1 = 18, .c2 = 17, .sum = 100, .inv_sum = 1.0 / 100.0 },
...
fn Padded(comptime len: comptime_int) type {
    return [len][len + pad]f32;
}

fn padRows(comptime len: comptime_int, table: [len][len]f32) Padded(len) {
    var out: Padded(len) = undefined;
    for (0..len) |y| {
        for (0..len + pad) |x| out[y][x] = table[y][x % len];
    }
    return out;
}

fn PaddedI16(comptime len: comptime_int) type {
    return [len][len + pad]i16;
}

fn padRowsI16(comptime len: comptime_int, table: [len][len]i16) PaddedI16(len) {
    var out: PaddedI16(len) = undefined;
    for (0..len) |y| {
        for (0..len + pad) |x| out[y][x] = table[y][x % len];
    }
    return out;
...
fn scaleTo256th(comptime len: comptime_int, table: [len][len]i16) [len][len]f32 {
    var out: [len][len]f32 = undefined;
    for (0..len) |y| {
        for (0..len) |x| out[y][x] = @as(f32, @floatFromInt(table[y][x])) / 256.0;
    }
    return out;
}

fn buildFmtcBayerI16() [16][16]i16 {
    const len = 16;
    var t: [len][len]i16 = @splat(@splat(-128));
    var dith_size: u32 = 2;
    while (dith_size <= len) : (dith_size <<= 1) {
        var y: u32 = 0;
        while (y < len) : (y += 2) {
            var x: u32 = 0;
            while (x < len) : (x += 2) {
                const xx = (x >> 1) + (len >> 1);
                const yy = (y >> 1) + (len >> 1);
                const val = (t[yy][xx] + 128) >> 2;
                t[y][x] = val + 0 - 128;
                t[y][x + 1] = val + 128 - 128;
                t[y + 1][x] = val + 192 - 128;
                t[y + 1][x + 1] = val + 64 - 128;
            }
        }
    }
    return t;
...
fn buildFmtcVoidI16() [32][32]i16 {
    const len = 32;
    var out: [len][len]i16 = undefined;
    var pos_block: usize = 0;
    var pos_byte: u6 = 0;
    for (0..len) |y| {
        for (0..len) |x| {
            const byte_val: u8 = @truncate(VOID_CLUSTER_PACKED[pos_block] >> (pos_byte * 8));
            out[y][x] = @as(i16, byte_val) - 128;
            pos_byte = (pos_byte + 1) % 8;
            if (pos_byte == 0) pos_block += 1;
        }
    }
    return out;
}

fn buildZimgTable(comptime len: comptime_int, table: [len][len]u8, comptime scale: comptime_int) [len][len]f32 {
    const sf: f32 = 1.0 / (@as(f32, scale) + 2.0);
    var out: [len][len]f32 = undefined;
    for (0..len) |y| {
        for (0..len) |x| out[y][x] = (@as(f32, @floatFromInt(table[y][x])) + 1.0) * sf - 0.5;
    }
    return out;
}

pub const fmtc_bayer_i16: PaddedI16(16) align(64) = blk: {
    @setEvalBranchQuota(100_000);
    break :blk padRowsI16(16, buildFmtcBayerI16());
};
pub const fmtc_void_i16: PaddedI16(32) align(64) = blk: {
    @setEvalBranchQuota(300_000);
    break :blk padRowsI16(32, buildFmtcVoidI16());
};
pub const fmtc_bayer_f32: Padded(16) align(64) = blk: {
    @setEvalBranchQuota(100_000);
    break :blk padRows(16, scaleTo256th(16, buildFmtcBayerI16()));
};
pub const fmtc_void_f32: Padded(32) align(64) = blk: {
    @setEvalBranchQuota(300_000);
    break :blk padRows(32, scaleTo256th(32, buildFmtcVoidI16()));
};

fn rotateBayer(comptime variant: u2, base: [16][16]f32) [16][16]f32 {
    var out: [16][16]f32 = undefined;
    for (0..16) |i| {
        for (0..16) |j| out[i][j] = switch (variant) {
            0 => base[i][j],
            1 => base[i][15 - j],
            2 => base[15 - i][j],
            3 => base[j][i],
...
pub const zimg_bayer_rot: [4]Padded(16) align(64) = blk: {
    @setEvalBranchQuota(400_000);
    const base = buildZimgTable(16, ZIMG_BAYER_TABLE, ZIMG_BAYER_TABLE_SCALE);
    break :blk .{
        padRows(16, rotateBayer(0, base)),
        padRows(16, rotateBayer(1, base)),
        padRows(16, rotateBayer(2, base)),
        padRows(16, rotateBayer(3, base)),
    };
};

pub const zimg_blue_noise_f32: Padded(64) align(64) = blk: {
    @setEvalBranchQuota(1_000_000);
    break :blk padRows(64, buildZimgTable(64, ZIMG_BLUE_NOISE_TABLE, ZIMG_BLUE_NOISE_SCALE));
};

pub const fmtc_bayer_len = 16;
